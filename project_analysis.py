...
EXTENSION = ".txt"
EXCLUDED_DIRS = {"node_modules", ".git", ".next", ".qodo", "__pycache__", ".vscode", ".idea"}
EXCLUDED_FILES = {"package-lock.json", "yarn.lock", ".DS_Store", "Thumbs.db"}
EXCLUDED_EXTENSIONS = {".png", ".jpg", ".jpeg", ".svg", ".gif", ".webp", ".ico", ".pdf", ".zip", ".tar", ".gz"}
...
def process_project():
    ...
    if not os.path.isdir(base_path):
        print(f"Project folder not found at: {base_path}")
        return
